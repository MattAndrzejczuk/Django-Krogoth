...
class InstallationRuntime():
    ...
    def __init__(self):
        ...
        cmd_n05 = ['docker', 'exec', '-it', 'armprime', 'pip3', 'install', '--upgrade', 'pip']
        cmd_n06 = ['docker', 'exec', '-it', 'armprime', 'pip3', 'install', '-r', 'requirements.txt']
        cmd_n07 = ['docker', 'exec', '-it', 'armprime', 'pip3', 'install', 'django-extensions']

        migrations_path = WORK_DIR.replace("docker", "")
        cmd_n08 = ['rm', '-R', migrations_path + 'krogoth_gantry/migrations']
        cmd_n09 = ['rm', '-R', migrations_path + 'krogoth_chat/migrations']
        cmd_n10 = ['rm', '-R', migrations_path + 'krogoth_3rdparty_api/migrations']
        cmd_n11 = ['rm', '-R', migrations_path + 'krogoth_examples/migrations']
        cmd_n12 = ['rm', '-R', migrations_path + 'krogoth_admin/migrations']
        cmd_n13 = ['rm', '-R', migrations_path + 'krogoth_apps/migrations']
        cmd_n14 = ['rm', '-R', migrations_path + 'krogoth_social/migrations']
