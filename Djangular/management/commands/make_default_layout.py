...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # homeLandingPage---------------------------------------------------------
        try:
            str_View = codecs.open('Djangular/management/default_templates/base_view.html', 'r').read()
            str_Module = codecs.open('Djangular/management/default_templates/base_module.js', 'r').read()
            str_Controller = codecs.open('Djangular/management/default_templates/base_controller.js', 'r').read()

            mvc = DjangularMasterViewController(name='home', title='It Works!')
