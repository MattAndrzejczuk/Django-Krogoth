...
from krogoth_gantry.models.example_models import Fruit, TextLabel, Manufacturer, Car, Topping, Pizza, Hotel, Occupant, \
    BasicImageUpload, BasicFileUpload
from krogoth_gantry.functions.example_serializers import FruitSerializer, TextLabelSerializer, ManufacturerSerializer, CarSerializer, \
