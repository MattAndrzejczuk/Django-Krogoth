(function() {
    ...
    function FUSE_APP_NAMEController($http, $log, $mdDialog, $mdToast) {
        ...
        function showAdvancedDialog(ev, title, file_type, mod_path) {
            ...
            $log.log('/moho_extractor/OpenTADataFile/?type=' + file_type + '&title=' + title + '&encoded_path=' + mod_path.replace('/LazarusII/UnitFBIViewset/?encoded_path=', ''));
            $log.log(mod_path);
            $log.log(mod_path);
            ...
            $mdDialog.show({
                    ...
                    templateUrl: '/moho_extractor/OpenTADataFile/?type=' + file_type + '&title=' + title + '&encoded_path=' + mod_path.replace('/LazarusII/UnitFBIViewset/?encoded_path=', ''),
        ...
        $http({
            method: 'GET',
            url: '/LazarusII/ExecuteBash_LS_AllCustomModFiles/?mod_repo=' + vm.modRepoParameterRESTful
