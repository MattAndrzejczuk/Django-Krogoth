(function() {
    ...
    function FUSE_APP_NAMEController($log, $scope, $http, $mdToast, $cookies, $state) {
        ...
        function getMasterViewControllerDetail(id) {
            $log.info('/krogoth_gantry/MasterViewControllerEditorDetail/?id=' + id);
            $http({
                method: 'GET',
        ...
        function putMasterViewControllerDetail() {
            ...
            $http({
                ...
                url: '/krogoth_gantry/MasterViewControllerEditorDetail/?id=' + vm.input.mvcId
            }).then(function successCallback(response) {
                /// Success
                $log.info('/krogoth_gantry/MasterViewControllerEditorDetail/?id=' + vm.input.mvcId);
                vm.editorContent = response.data;
