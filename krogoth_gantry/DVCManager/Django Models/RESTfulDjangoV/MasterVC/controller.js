(function () {
    ...
    function FUSE_APP_NAMEController($mdToast, $timeout, $log, RESTfulModelV) {
        var vm = this;
        ...
        function getObjectList() {
            ...
            RESTfulModelV.getList().then(function (data) {
        ...
        function deleteObject(withId) {
            RESTfulModelV.deleteObject(withId).then(function (data) {
                vm.jsonResponse.pop(data);
            });
        }

        function postNewObject() {
            RESTfulModelV.postNewObject(vm.RESTfulJSONPayload).then(function (data) {
