(function () {
    ...
    function FUSE_APP_NAMEController($mdToast, $timeout, $log, RESTfulModelIII) {
        var vm = this;
        ...
        function getObjectList() {
            ...
            RESTfulModelIII.getList().then(function (data) {
        ...
        function deleteObject(withId) {
            RESTfulModelIII.deleteObject(withId).then(function (data) {
                vm.jsonResponse.pop(data);
            });
        }

        function postNewObject() {
            RESTfulModelIII.postNewObject(vm.RESTfulJSONPayload).then(function (data) {
