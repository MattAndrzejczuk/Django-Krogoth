(function() {
    ...
    function config($stateProvider, $translatePartialLoaderProvider, msApiProvider, msNavigationServiceProvider) {
		...
		By default, the string krogoth_categories above will automatically generate
        the following code:     
		...
		msNavigationServiceProvider.saveItem("Primary", {
			title: "Primary",
			icon: "entypo entypo-window",
			weight: 1
		});
		msNavigationServiceProvider.saveItem("Primary.Required", {
			title: "Required",
			icon: "mdi mdi-MDImdi mdi-power-socket-us",
			weight: 0
		});
		...
		msNavigationServiceProvider.saveItem("Primary.Auth", {
			title: "Auth",
			icon: "mdi mdi-MDImdi mdi-power-socket-us",
			weight: 0
		});
