(function() {
    ...
    function FUSE_APP_NAMEController($mdToast, $timeout, $log, RESTfulModelVII) {
        ...
        function getFKList() {
            RESTfulModelVII.getManyToManyKeys().then(function(data) {
        ...
        function getObjectList() {
            ...
            RESTfulModelVII.getList().then(function(data) {
        ...
        function deleteObject(withId) {
            RESTfulModelVII.deleteObject(withId).then(function(data) {
        ...
        function postNewObject() {
            RESTfulModelVII.postNewObject(vm.RESTfulJSONPayload).then(function(data) {
        ...
        function putModifiedObject(objId) {
            RESTfulModelVII.putEditedObject(vm.RESTfulJSONPayload, objId).then(function(data) {
