...
urlpatterns = [
    ...
    path('ram/', resource_dashboard.getRam.as_view(), name='ram'),
    path('processes/', resource_dashboard.getProcesses.as_view(), name='processes'),
    path('processesDummy/', resource_dashboard.getProcessesDummy.as_view(), name='processesDummy'),
    path('storage/', resource_dashboard.getStorage.as_view(), name='storage'),
    path('cpuinfo/', resource_dashboard.getCPUInfo.as_view(), name='cpuinfo'),
    path('uptime/', resource_dashboard.getUpTime.as_view(), name='uptime'),
]
