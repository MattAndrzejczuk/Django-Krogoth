...
class KrogothGantryMasterViewController(models.Model):
    ...
    djangular_directive = models.ManyToManyField(KrogothGantryDirective, null=True, blank=True)
    djangular_slave_vc = models.ManyToManyField(KrogothGantrySlaveViewController, null=True, blank=True)
