(function() {
    ...
    function FUSE_APP_NAMEController($mdToast, $timeout, $log, RESTfulModelIV) {
        var vm = this;
        ...
        function getFKList() {
            RESTfulModelIV.getForeignKeys().then(function(data) {
        ...
        function getObjectList() {
            ...
            RESTfulModelIV.getList().then(function(data) {
        ...
        function deleteObject(withId) {
            RESTfulModelIV.deleteObject(withId).then(function(data) {
                vm.jsonResponse.pop(data);
            });
        }

        function postNewObject() {
            RESTfulModelIV.postNewObject(vm.RESTfulJSONPayload).then(function(data) {
