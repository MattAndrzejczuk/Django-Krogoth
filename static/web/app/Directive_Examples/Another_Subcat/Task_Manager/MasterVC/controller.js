(function () {
    ...
    function FUSE_APP_NAMEController($scope, $interval, $http) {
        let vm = this;
        vm.$onInit = onInit;
        ...
        function refreshProcesses() {
            $http({
                method: 'GET',
                url: '/krogoth_examples/processesDummy?format=json'
        ...
        vm.appendDataToPhysicalMemory = function() {
            $log.log('TODO: vm.appendDataToPhysicalMemory is an empty function! ! ')
        };
        ...
        $interval(function() {
            $http({
                method: 'GET',
                url: '/krogoth_examples/ram?format=json'
            }).then(function successCallback(response) {
        ...
        $http({
            method: 'GET',
            url: '/krogoth_examples/cpuinfo?format=json'
        }).then(function successCallback(response) {
        ...
        $interval(function() {
            $http({
                method: 'GET',
                url: '/krogoth_examples/storage?format=json'
            }).then(function successCallback(response) {
                vm.widget2["title"] = response.data['data'][0];
                vm.widget2["value"]["used"] = response.data['data'][2];
                vm.widget2["value"]["total"] = response.data['data'][1];
                vm.widget2["value"]["percentage"] = parseFloat(response.data['data'][4].replace('%', ''));
                vm.diskspacePercentage = parseFloat(response.data['data'][4].replace('%', ''));
            }, function errorCallback(response) {});
        }, 2000);
        ...
        $interval(function() {
            $http({
                method: 'GET',
                url: '/krogoth_examples/uptime?format=json'
            }).then(function successCallback(response) {
