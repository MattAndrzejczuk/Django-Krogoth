class TotalAAssembler(object):
    ...
    def compileToWeaponTDF(self, weapon_tdf_json: dict, jkey: str):
        newtdf = '\n\n[' + jkey + ']\n{\n'
    ...
    def compileToFeatureTDF(self, _json: dict, jkey: str):
        newtdf = '\n\n[' + jkey + ']\n{\n'
    ...
    def compileToDownloadTDF(self, _json: dict, u1: str, u2: str):
        tdfHeader = ''
        newtdf = ''
        entry = ''
        for k, v in _json.items():
    ...
    def compileToUnitFBI(self, _json: dict, unit_name: str):
        newtdf = '\n\n[UNITINFO]\n{\n'
        for k,v in _json.items():
            newtdf += '    ' + k + '=' + v + ';\n'
        newtdf += '}'
