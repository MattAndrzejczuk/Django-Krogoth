# -*- coding: utf-8 -*-
# Generated by Django 1.11.3 on 2017-07-15 02:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Djangular Lazarus', max_length=255)),
                ('width', models.IntegerField(default=250)),
                ('font_size', models.IntegerField(default=36)),
                ('logo_background_color', models.CharField(default='white', help_text='"blue", "aqua", "white", etc...', max_length=255)),
                ('font_color', models.CharField(default='black', help_text='"blue", "aqua", "white", etc...', max_length=255)),
                ('main_background_color', models.CharField(default='darkolivegreen', help_text='"blue", "aqua", "white", etc...', max_length=255)),
                ('spinner_color', models.CharField(default='antiquewhite', max_length=255)),
                ('html_code', models.TextField(default='<ms-splash-screen id="splash-screen">\n\t <div class="center">\n\t\t <div class="logo" style="width:250px; font-size: 36px; background-color: darkorange;">\n\t\t <span>Lazarus</span>\n\t\t </div>\n <!-- Material Design Spinner --> \n<div class="spinner-wrapper"> \n<div class="spinner"> \n<div class="inner"> \n<div class="gap"></div> \n<div class="left"> \n<div class="half-circle"></div> </div> \n<div class="right"> \n<div class="half-circle"></div> </div> </div> </div> </div> <!-- / Material Design Spinner --> </div></ms-splash-screen>')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(default='default_layout', max_length=255, unique=True)),
                ('title', models.CharField(default='Djangular', max_length=55)),
